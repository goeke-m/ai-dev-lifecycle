...
.DESCRIPTION
    Reads the dev-lifecycle config, assembles rule files based on what is
...
.NOTES
    Set LIFECYCLE_DIR environment variable to override ~/.dev-lifecycle.
#>
...
$Header = @"
<!-- Auto-generated by dev-lifecycle. Do not edit manually. -->
<!-- Source: https://github.com/goeke-m/dev-lifecycle -->
